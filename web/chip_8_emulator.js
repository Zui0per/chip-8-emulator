...
export class Emulator {
     ...
     */
    get_framebuffer_ptr() {
        const ret = wasm.emulator_get_framebuffer_ptr(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @returns {number}
     */
    get_framebuffer_len() {
        const ret = wasm.emulator_get_framebuffer_len(this.__wbg_ptr);
        return ret >>> 0;
    }
    execute_instruction() {
        wasm.emulator_execute_instruction(this.__wbg_ptr);
    }
}
